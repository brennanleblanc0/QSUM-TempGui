...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.browseSaveLine.setText(f"QSUM_TempLog_{datetime.utcnow().strftime("%m.%Y")}.txt")
        self.browseLoadLine.setText(f"QSUM_TempLog_{datetime.utcnow().strftime("%m.%Y")}.txt")
        self.displayData()
